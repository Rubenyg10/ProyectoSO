...
int main(int argc, char **argv)
{
	...
	char consulta [80];
	strcpy (consulta,"SELECT Partida.ganador FROM Partida,Participacion WHERE Participacion.Color = "rojo"");
	strcat (consulta, ganador);
	strcat (consulta,"'AND Partida.id_p = Participacion.Partida);
